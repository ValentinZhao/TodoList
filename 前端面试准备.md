...
利用HTML5的历史相关API，比如pushState和replaceState来实现跳转不刷新，并且能正确记录后退历史。在html5出来前，实现无刷新前进后退通常是结合location.hash+onhashchange事件来实现的；
...
## Front-end router
[FE Router](http://blog.csdn.net/sunxinty/article/details/52586556)
