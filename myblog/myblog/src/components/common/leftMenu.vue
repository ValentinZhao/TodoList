  ...
  <div class="aside-left rd-col-4">
    <div class="aside-panel">
      <div class="aside-head-avator">
        <img class="aside-head-img" src="../../assets/img/ryan.jpeg" alt="" />
        <h3 class="aside-head-title">
          <a href="">
            Valentin
          </a>
        </h3>
        <span class="aside-head-subtitle">大前端爬坑</span>
      </div>
      <ul class="aside-menu-list">
        <li class="aside-menu-item" v-for="item in menus">{{item.name}}</li>
      </ul>
    </div>
  </div>
</template>
